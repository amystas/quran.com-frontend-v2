...
TranslationIO.configure do |config|
  ...
  config.target_locales = ['sq', 'am-ET', 'ar', 'az', 'bn-BD', 'zh-CN', 'dv', 'nl', 'fr', 'de', 'ha-Latn-NG', 'he', 'hi', 'id', 'it', 'ja', 'ks', 'ko', 'ms', 'ne-NP', 'ps-AF', 'fa', 'pt-BR', 'ru', 'sd', 'si-LK', 'so', 'es', 'ta', 'te', 'te-IN', 'th', 'tr', 'ug-CN', 'ur', 'vi', 'yo-NG' , 'pl']
